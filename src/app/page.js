  ...
  return (
    <>
          ...
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 10 : 0.85}>
                <h1>Interiors that feel grounded, warm, and quietly considered</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 10.15 : 1}>
                <p>
                  At Solene, we craft interiors that slow the day down, invite
                  stillness, and speak through material, proportion, and light.
                </p>
              </Copy>
            </div>
            <AnimatedButton
        ...
        <div className="container">
          <div className="what-we-do-header">
            <Copy delay={0.1}>
              <h1>
                ...
                At Solene, we design with restraint and intent, shaping
                interiors that speak through light, proportion, and the quiet
                assurance of materials made to last.
              </h1>
            </Copy>
          </div>
          <div className="what-we-do-content">
            <div className="what-we-do-col">
              ...
              <Copy delay={0.15}>
                <p className="lg">
                  We begin every project by listening. Each plan is shaped
                  through research, drawing, and conversation until only the
                  essential remains, designed to last and made to feel lived in.
                </p>
              </Copy>
            </div>
            <div className="what-we-do-col">
      ...
      <section className="featured-projects-container">
        <div className="container">
          ...
          <div className="featured-projects-header">
            <Copy delay={0.15}>
              <h2>A selection of recent interiors and ongoing studies</h2>
            </Copy>
          </div>
        </div>
        <FeaturedProjects />
      ...
      <section className="client-reviews-container">
        <div className="container">
          <div className="client-reviews-header-callout">
            <p>Words from the people who live in them</p>
          </div>
          <ClientReviews />
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="gallery-callout-col">
            <div className="gallery-callout-copy">
              <Copy delay={0.1}>
                <h3>
                  Take a closer look at the interiors that define our practice.
                  From intimate rooms to open, light-filled volumes, each frame
                  captures a perspective that might shape your own space.
                </h3>
              </Copy>
      ...
      <CTAWindow
        ...
        header="Solene"
        callout="Rooms that deepen with time"
        description="Our work is guided by rhythm, proportion, and light, so every interior grows more resolved the longer it is lived in."
      />
      <ConditionalFooter />
    </>
  );
