          ...
          <div className="footer-meta-col">
            <div className="footer-meta-block">
              <div className="footer-meta-logo">
                <Copy delay={0.1}>
                  <h3 className="lg">Solene</h3>
                </Copy>
              </div>
              <Copy delay={0.2}>
                <h2>Interiors made calm, tactile, and lasting.</h2>
              </Copy>
            </div>
          </div>
          <div className="footer-meta-col">
          ...
          <div className="footer-meta-col">
            <Copy delay={0.1}>
              <p>
                ...
                shapes how a room is felt and lived in.
              </p>
            </Copy>
          </div>
        </div>
      ...
      <div className="footer-outro">
        <div className="container">
          <div className="footer-header">
            <img src="/logos/solene-wordmark.svg" alt="Solene" />
          </div>
          <div className="footer-copyright">
            <p>
              Designed &amp; built by — <span>digifox.world</span>
            </p>
