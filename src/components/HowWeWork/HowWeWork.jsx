      ...
      <div className="how-we-work-col how-we-work-header" ref={headerRef}>
        <div className="container">
          <div className="how-we-work-header-content">
            ...
            <Copy delay={0.15}>
              <h3>
                From first sketches to final details, our process is built to
                bring clarity, calm, and rhythm
              </h3>
            </Copy>
      ...
      <div className="how-we-work-col how-we-work-cards" ref={cardsRef}>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We start by listening. Site, light, and the rhythms of daily
              life inform the brief, so we can set the aims, limits, and measures
              of success together with clarity.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We set guiding principles for light, layout, and flow. Quick
              sketches and moodboards test the options and reveal the direction
              that best serves the brief.
            </p>
          </div>
        </div>
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We develop drawings and specifications across finishes, lighting,
        ...
        <div className="how-we-work-card">
          ...
          <div className="how-we-work-card-copy">
            ...
            <p className="md">
              We oversee the build with care and precision. After a final
              review and styling, we hand over a room that is ready to live in,
              complete with guidance for its long-term care.
            </p>
          </div>
        </div>
      </div>
